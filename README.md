...
- **Env files** create .env in both project following the .env.example
...
### 5. Approach to Data Extraction and Processing
...
### 6. Chosen Tech Stack and Rationale Technology
